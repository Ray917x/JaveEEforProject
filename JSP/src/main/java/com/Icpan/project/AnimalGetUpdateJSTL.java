...
@WebServlet("/AnimalGetUpdateJSTL")
public class AnimalGetUpdateJSTL extends HttpServlet {
...
//				animal.setAnimal_update(rs.getString("animal_update"));
			...
			request.getRequestDispatcher("project/AnimalUpdate.jsp").forward(request, response);
